...
export class FormAprComponent implements OnInit {
  ...
  constructor(private readonly route: ActivatedRoute, private apiService: ApiService, private fb: FormBuilder,private commonservice: CommonService) {
    ...
    this.aprForm = this.fb.group({
      ...
      APR_Dec_A: new FormControl('',Validators.required),
      APR_Dec_B: new FormControl('',Validators.required),
      APR_Dec_C: new FormControl('',Validators.required),
      APR_Dec_D: new FormControl('',Validators.required),
      APR_Dec_E: new FormControl('',Validators.required),
